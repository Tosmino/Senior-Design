...
#define ENABLE_CMD_DELAY          25 // Milliseconds
#define ALGO_CMD_DELAY_SHORT      25 // Milliseconds
#define ALGO_CMD_DELAY_LONG       25 // Milliseconds
#define CMD_DELAY                 2 // Milliseconds
#define MAXFAST_ARRAY_SIZE        6  // Number of bytes....
#define MAXFAST_EXTENDED_DATA     5
#define MAX86141_LED_ARRAY        12 // 4 values of 24 bit (3 byte) LED values
...
enum READ_SENSOR_ENABLE_INDEX_BYTE {
  ...
  READ_ENABLE_MAX86141 = 0x00,
  READ_ENABLE_ACCELEROMETER = 0x04

};

// Index Byte for the Family Byte: WAKE_ON_MOTION (0x46)
enum WAKE_ON_MOTION_INDEX_BYTE {
  WAKE_MAX86141_ON_MOTION = 0x00
...
class SparkFun_Bio_Sensor_Hub
{
  public:
    ...
    uint8_t senArr[MAX86141_LED_ARRAY] {};
    uint8_t bpmSenArr[MAXFAST_ARRAY_SIZE + MAX86141_LED_ARRAY] {};
    uint8_t bpmSenArrTwo[MAXFAST_ARRAY_SIZE + MAXFAST_EXTENDED_DATA + MAX86141_LED_ARRAY] {};
    ...
    // Family Byte: READ_SENSOR_MODE (0x45), Index Byte: READ_ENABLE_MAX86141 (0x00)
    // This function checks if the MAX86141 is enabled or not.
    uint8_t readMAX86141State();
    ...
    // Family Byte: WRITE_REGISTER (0x40), Index Byte: WRITE_MAX86141 (0x00), Write Bytes:
    ...
    void writeRegisterMAX86141(uint8_t, uint8_t);
    ...
    // Family Byte: READ_ATTRIBUTES_AFE (0x42), Index Byte: RETRIEVE_AFE_MAX86141/ (0x00)
    ...
    sensorAttr getAfeAttributesMAX86141();
    ...
    // Family Byte: DUMP_REGISTERS (0x43), Index Byte: DUMP_REGISTER_MAX86141 (0x00)
    ...
    uint8_t dumpRegisterMAX86141(uint8_t regArray[]);
